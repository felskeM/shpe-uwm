        ...
        >
            ...
            <div className="relative flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
                ...
                <div className="flex gap-2">
                    <a href="/contact" className="px-4 py-2 btn-ghost bg-black/40 hover:bg-black/55 backdrop-blur ring-1 ring-white/10">
                        Become a sponsor
                    </a>
                    {/* ADD FILE */}
                    <a
                        href={packetHref}
                        className="px-4 py-2 btn-primary ring-1 ring-white/10"
                        target="_blank"
